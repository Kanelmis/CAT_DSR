...
def prepare_uaspeech(
    ...
    for split_index, split in enumerate(splits):
        ...
        if split_by_block:
            ...
            create_csv(
                save_folder, control_lst, text_dict, split + "-control", n_sentences,
            )
    ...
    if merge_lst and merge_name is not None:
        for category in ["", "-control"] if split_by_block else [""]:
            ...
            merge_csvs(
                data_folder=save_folder, csv_lst=merge_files, merged_csv=merge_name.replace(".", category+".") ,
            )
...
if __name__ == "__main__":
    prepare_uaspeech(
        "/mnt/DataSets/Speech Datasets/UASpeech",
        "/home/qwan121/transformer/",
        ["M04_B1", "M04_B2"],
        ["M04_B3"],
        ["M04_B3"]
    )
