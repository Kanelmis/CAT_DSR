...
yaml_files=("transfer_mixed_dysarthric_torgo.yaml" "transfer_mixed_dysarthric_ua.yaml")

# Base output folder paths
output_folders=("results/transfer_dysarthric_mixed_torgo_" "results/transfer_dysarthric_mixed_ua_")
