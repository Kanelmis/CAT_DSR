...
yaml_files=("transfer_p1_dysarthric_ua.yaml" "transfer_p1_dysarthric_torgo.yaml")

# Base output folder paths
output_folders=("results/transfer_dysarthric_p1_ua_" "results/transfer_dysarthric_p1_torgo_")
