...
yaml_files=("transfer_p2_dysarthric_ua.yaml" "transfer_p2_dysarthric_torgo.yaml")

# Base output folder paths
output_folders=("results/transfer_dysarthric_p2_ua_" "results/transfer_dysarthric_p2_torgo_")
